...
# 3.1. determine if a string is included in another string?
"another string".include? "string"
...
new_string = "eels in my hovercraft".gsub(/eels/, "fish").gsub(/hovercraft/, "sink")
...
best_vehicle = vehicle << " that shoots rainbow bunnies"
...
puts "Guess my age..."
while (guess != age) && (num_guesses <= 4)
  num_guesses += 1
  guess = gets.chomp!.to_i
  if guess > (10 + age)
    puts "Wow. You suck. You don't get to try anymore. >:C"
    break
  elsif guess != age
    puts "Nope. Try again."
  end
...
puts "Good stuff! You guessed right!" if guess == age
